...
import { validateCreatePost, validateModifyPost } from '../middleware/posts.js'
...
.patch([validateAccess, validateModifyPost], modifyPostCtrl)
.delete([validateAccess], deletePostCtrl)
