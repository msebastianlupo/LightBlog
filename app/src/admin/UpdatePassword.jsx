...
function UpdatePassword(){
    ...
    return(
        <div>
            <p className={`mar-t-2 tex-a-c tex-2 ${messageStyles}`}>{message}</p>
            <form className="chidis-f chidir-c chiinv mar-t-2 chimar-t-2 neu-1 pad-2 rad-1" onSubmit={updatePassword}>
