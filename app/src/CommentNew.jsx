    ...
    return(
        <>

            {
                !hasComment ?
                    <>
                        <h2 className="tex-a-c mar-t-8">Dejá tu comentario</h2>
                        <p className="mar-t-4 tex-a-c tex-2">{message}</p>
                        <form className="chidis-f chidir-c chiinv mar-t-2 chimar-t-2 neu-1 pad-2 rad-1" onSubmit={createComment}>
                ...
                : <h2 className="tex-a-c mar-t-8 mar-b-4">{message}</h2>
            }
        </>
    )
}
